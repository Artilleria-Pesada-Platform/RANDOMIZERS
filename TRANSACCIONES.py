...
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_OCTUBRE.csv")
Randomizer_TRANSACCIONES(3,15,11, 2021,DF_TRANSACCIONES_NOVIEMBRE)
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_NOVIEMBRE.csv")
Randomizer_TRANSACCIONES(3,15,12, 2021,DF_TRANSACCIONES_DICIEMBRE)
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_DICIEMBRE.csv")
Randomizer_TRANSACCIONES(3,15,1, 2022,DF_TRANSACCIONES_ENERO)
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_ENERO.csv")
Randomizer_TRANSACCIONES(3,15,2, 2022,DF_TRANSACCIONES_FEBRERO)
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_FEBRERO.csv")
Randomizer_TRANSACCIONES(3,15,3, 2022,DF_TRANSACCIONES_MARZO)
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_MARZO.csv")
Randomizer_TRANSACCIONES(3,15,4, 2022,DF_TRANSACCIONES_ABRIL)
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_ABRIL.csv")
Randomizer_TRANSACCIONES(3,15,5, 2022,DF_TRANSACCIONES_MAYO)
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_MAYO.csv")
Randomizer_TRANSACCIONES(3,15,6, 2022,DF_TRANSACCIONES_JUNIO)
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_JUNIO.csv")
Randomizer_TRANSACCIONES(3,15,7, 2022,DF_TRANSACCIONES_JULIO)
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_JULIO.csv")
Randomizer_TRANSACCIONES(3,15,8, 2022,DF_TRANSACCIONES_AGOSTO)
DF_TRANSACCIONES_SEPTIEMBRE.to_csv("TRANSACCIONES/DF_TRANSACCIONES_AGOSTO.csv")
